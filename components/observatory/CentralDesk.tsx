...
export default function CentralDesk({ initialBranch, active = true, instrumentMode = false, onRoomReturn, initialPrompt }: { initialBranch?: string; active?: boolean; instrumentMode?: boolean; onRoomReturn?:()=>void; initialPrompt?:string }) {
  ...
  }, [advanced, structured, prompt, sound, active, instrumentMode]);
  useEffect(() => {
