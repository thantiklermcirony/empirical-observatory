...
import ontology from './ontology-summary.json' with {type:'json'};
...
export function scientificLedger(){
 ...
 return {schema:LEDGER_VERSION,scope:'Federated scientific seed ledger. Coverage of a classification is not complete knowledge, empirical validation or universal law.',stages:LEDGER_STAGES,ontology:{...ontology,browser:'/ledger',lookupImplementation:'lib/ontology-browser.ts',authority:'Source vocabulary only; no new execution contracts.'},
